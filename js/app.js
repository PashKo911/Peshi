(() => {
    ...
    function initSliders() {
        if (document.querySelector(".merch__slider")) new swiper_core_Swiper(".merch__slider", {
        ...
        if (document.querySelector(".nft__slider")) new swiper_core_Swiper(".nft__slider", {
